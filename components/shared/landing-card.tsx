...
function LandingCard() {
    ...
    return (
        <Box className={`flex ${(isBrowser && !isMobile) ? 'min-h-[500px]' : 'min-h-[350px]'} flex-col h-full items-start justify-center gap-10 px-4 md:flex-row md:items-center md:justify-between md:gap-0 md:px-32 md:pt-24 pt-6 pb-4`}>
            <Box className="z-10 md:my-auto md:py-32 flex min-h-[350px] w-full flex-col items-start justify-center gap-4 md:w-1/2">
                <Box className="absolute top-10 right-4 h-[65px] w-[65px] max-md:opacity-0">
                    <Image
                        fill
                        priority
                ...
                <Box className="absolute top-10 left-2 h-[65px] w-[65px] max-md:opacity-0">
                    <Image
                        fill
                        priority
                        src="/maze.svg" alt={''}
            ...
            <Box className="flex w-full flex-col items-start justify-start md:w-1/2">
                <Box className="-z-10 flex h-full w-full items-center justify-center">
                    ...
                    <Box className="absolute -z-10 h-[500px] w-[500px] max-md:w-full max-md:aspect-square relative">
                        <Image 
