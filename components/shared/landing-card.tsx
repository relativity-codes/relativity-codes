...
function LandingCard() {
    ...
    return (
        <Box className={`flex ${(isBrowser && !isMobile) ? 'min-h-[500px]' : 'min-h-[350px]'} flex-col h-full items-start justify-center gap-10 px-4 md:flex-row md:items-center md:justify-between md:gap-0 md:px-32 py-12`}>
            ...
            <Box className="flex w-full flex-col items-start justify-start md:w-1/2">
                <Box className="-z-10 flex h-full w-full items-center justify-center">
                    ...
                    <Box className="absolute -z-10 h-[500px] w-[500px] max-md:w-full">
                        ...
                        />
                        <Box className="absolute bottom-0 left-0 flex h-8 w-[500px] flex-row items-center justify-center border border-solid border-white px-2 max-md:bottom-10 max-md:w-full">
                            <Box className="flex">
