...
function LandingCard() {
    ...
    return (
        <Box className={`flex ${(isBrowser && !isMobile) ? 'min-h-[500px]' : 'min-h-[350px]'} flex-col h-full items-start justify-center gap-10 px-4 md:flex-row md:items-center md:justify-between md:gap-0 md:px-32 md:pt-24 pb-4`}>
            ...
            <Box className="flex w-full flex-col items-start justify-start md:w-1/2">
                <Box className="-z-10 flex h-full w-full items-center justify-center">
                    ...
                    <Box className="absolute -z-10 h-[500px] w-[500px] max-md:w-full">
                        <Image
                            className="mask-fade-content-sides opacity-[1] max-md:w-full max-md:aspect-square"
                            fill
                            priority
                            src="/avatar.png" alt={''}
                        />
