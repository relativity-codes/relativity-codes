...
const ContactPage = () => {
    ...
    return (
        <div className="flex w-full flex-grow flex-col px-4 py-16 md:px-32">
            <h1 className="mb-8 flex w-full text-2xl font-bold">Contact Me</h1>
            ...
            <div className="flex w-full flex-col items-start justify-center gap-4 md:flex-grow md:flex-row md:items-center md:justify-between">
                {/* Contact Form */}
                <div className="flex w-full flex-grow flex-col rounded-lg bg-black p-6 text-white shadow-md md:w-1/2">
